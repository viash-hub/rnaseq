...
meta = [
  ...
  "functionality" : {
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/nirmayi/data_intuitive/rnaseq.vsh/src/bbmap_bbsplit/"
      }
    ],
    ...
    "test_resources" : [
      ...
      {
        "type" : "file",
        "path" : "testData/reference/bbsplit_fasta/sarscov2.fa",
        "parent" : "file:///home/nirmayi/data_intuitive/rnaseq.vsh/"
      },
      {
        "type" : "file",
        "path" : "testData/reference/bbsplit_fasta/human.fa",
        "parent" : "file:///home/nirmayi/data_intuitive/rnaseq.vsh/"
      }
    ],
    "info" : {
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "output" : "/home/nirmayi/data_intuitive/rnaseq.vsh/target/nextflow/bbmap_bbsplit",
...
$( if [ ! -z ${VIASH_PAR_BBSPLIT_FASTA_LIST+x} ]; then echo "${VIASH_PAR_BBSPLIT_FASTA_LIST}" | sed "s#'#'\\"'\\"'#g;s#.*#par_bbsplit_fasta_list='&'#" ; else echo "# par_bbsplit_fasta_list="; fi )
...
$( if [ ! -z ${VIASH_PAR_BUILT_BBSPLIT_INDEX+x} ]; then echo "${VIASH_PAR_BUILT_BBSPLIT_INDEX}" | sed "s#'#'\\"'\\"'#g;s#.*#par_built_bbsplit_index='&'#" ; else echo "# par_built_bbsplit_index="; fi )
...
$( if [ ! -z ${VIASH_PAR_BBSPLIT_INDEX+x} ]; then echo "${VIASH_PAR_BBSPLIT_INDEX}" | sed "s#'#'\\"'\\"'#g;s#.*#par_bbsplit_index='&'#" ; else echo "# par_bbsplit_index="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "data-intuitive/bbmap_bbsplit",
    "tag" : "dev"
  },
  "tag" : "$id"
}'''),
