...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/src/cat_fastq/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/target/nextflow/cat_fastq",
...
$( if [ ! -z ${VIASH_PAR_READ_1+x} ]; then echo "${VIASH_PAR_READ_1}" | sed "s#'#'\\"'\\"'#g;s#.*#par_read_1='&'#" ; else echo "# par_read_1="; fi )
$( if [ ! -z ${VIASH_PAR_READ_2+x} ]; then echo "${VIASH_PAR_READ_2}" | sed "s#'#'\\"'\\"'#g;s#.*#par_read_2='&'#" ; else echo "# par_read_2="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "data-intuitive/cat_fastq",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
