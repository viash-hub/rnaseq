...
meta = [
  ...
  "functionality" : {
    ...
    "arguments" : [
      ...
      },
      {
        "type" : "file",
        "name" : "--filtered_gtf",
        "description" : "Filtered GTF file containing only genes in the genome",
        "must_exist" : true,
        "create_parent" : true,
        "required" : false,
        "direction" : "output",
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/nirmayi/data_intuitive/rnaseq.vsh/src/gtf_gene_filter/"
      },
      {
        "type" : "file",
        "path" : "filter_gtf_for_genes_in_genome.py",
        "parent" : "file:/home/nirmayi/data_intuitive/rnaseq.vsh/src/gtf_gene_filter/"
      }
    ],
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "output" : "/home/nirmayi/data_intuitive/rnaseq.vsh/target/nextflow/gtf_gene_filter",
...
$( if [ ! -z ${VIASH_PAR_FILTERED_GTF+x} ]; then echo "${VIASH_PAR_FILTERED_GTF}" | sed "s#'#'\\"'\\"'#g;s#.*#par_filtered_gtf='&'#" ; else echo "# par_filtered_gtf="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "data-intuitive/gtf_gene_filter",
    "tag" : "dev"
  },
  "tag" : "$id"
}'''),
