...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/src/getchromsizes/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/target/nextflow/getchromsizes",
...
$( if [ ! -z ${VIASH_PAR_GZI+x} ]; then echo "${VIASH_PAR_GZI}" | sed "s#'#'\\"'\\"'#g;s#.*#par_gzi='&'#" ; else echo "# par_gzi="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "data-intuitive/getchromsizes",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
