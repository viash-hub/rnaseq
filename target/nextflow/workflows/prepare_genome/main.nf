...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/src/workflows/prepare_genome/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/target/nextflow/workflows/prepare_genome",
...
include { gunzip } from "${meta.resources_dir}/../../../nextflow/gunzip/main.nf"
include { gffread } from "${meta.resources_dir}/../../../nextflow/gffread/main.nf"
include { cat_additional_fasta } from "${meta.resources_dir}/../../../nextflow/cat_additional_fasta/main.nf"
include { gtf2bed } from "${meta.resources_dir}/../../../nextflow/gtf2bed/main.nf"
include { preprocess_transcripts_fasta } from "${meta.resources_dir}/../../../nextflow/preprocess_transcripts_fasta/main.nf"
include { gtf_filter } from "${meta.resources_dir}/../../../nextflow/gtf_filter/main.nf"
include { rsem_prepare_reference } from "${meta.resources_dir}/../../../nextflow/rsem/rsem_prepare_reference/main.nf"
include { getchromsizes } from "${meta.resources_dir}/../../../nextflow/getchromsizes/main.nf"
include { untar } from "${meta.resources_dir}/../../../nextflow/untar/main.nf"
include { star_genomegenerate } from "${meta.resources_dir}/../../../nextflow/star/star_genomegenerate/main.nf"
include { bbmap_bbsplit } from "${meta.resources_dir}/../../../nextflow/bbmap_bbsplit/main.nf"
include { salmon_index } from "${meta.resources_dir}/../../../nextflow/salmon/salmon_index/main.nf"
include { kallisto_index } from "${meta.resources_dir}/../../../nextflow/kallisto/kallisto_index/main.nf"
