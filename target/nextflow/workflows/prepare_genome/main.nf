    ...
    "resources" : [
      {
        ...
        "path" : "main.nf",
        "is_executable" : true,
        "parent" : "file:/home/nirmayi/data_intuitive/rnaseq.vsh/src/workflows/prepare_genome/",
        "entrypoint" : "run_wf"
      }
    ],
...
include { gtf_gene_filter } from "${meta.resources_dir}/../../../nextflow/gtf_gene_filter/main.nf"
