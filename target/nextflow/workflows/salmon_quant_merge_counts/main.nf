// salmon_quant_merge_counts main_build
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/src/workflows/salmon_quant_merge_counts/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/target/nextflow/workflows/salmon_quant_merge_counts",
...
include { tx2gene } from "${meta.resources_dir}/../../../nextflow/tx2gene/main.nf"
include { tximport } from "${meta.resources_dir}/../../../nextflow/tximport/main.nf"
include { summarizedexperiment } from "${meta.resources_dir}/../../../nextflow/summarizedexperiment/main.nf"
