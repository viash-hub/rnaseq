...
meta = [
  ...
  "description" : "Counts the number of alignments in a BAM file for each FLAG type\n",
  "test_resources" : [
    {
      "type" : "bash_script",
      "path" : "test.sh",
  ...
  "build_info" : {
    "config" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/src/samtools/samtools_flagstat/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/target/nextflow/samtools/samtools_flagstat",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "data-intuitive/samtools/samtools_flagstat",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
