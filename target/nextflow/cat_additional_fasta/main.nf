...
meta = [
  ...
  "functionality" : {
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/nirmayi/data_intuitive/rnaseq.vsh/src/cat_additional_fasta/"
      },
      {
        "type" : "file",
        "path" : "fasta2gtf.py",
    ...
    "test_resources" : [
      ...
      {
        "type" : "file",
        "path" : "testData/reference/gfp.fa.gz",
        "parent" : "file:///home/nirmayi/data_intuitive/rnaseq.vsh/"
      }
    ],
    "info" : {
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "output" : "/home/nirmayi/data_intuitive/rnaseq.vsh/target/nextflow/cat_additional_fasta",
...
$( if [ ! -z ${VIASH_PAR_ADDITIONAL_FASTA+x} ]; then echo "${VIASH_PAR_ADDITIONAL_FASTA}" | sed "s#'#'\\"'\\"'#g;s#.*#par_additional_fasta='&'#" ; else echo "# par_additional_fasta="; fi )
$( if [ ! -z ${VIASH_PAR_BIOTYPE+x} ]; then echo "${VIASH_PAR_BIOTYPE}" | sed "s#'#'\\"'\\"'#g;s#.*#par_biotype='&'#" ; else echo "# par_biotype="; fi )
$( if [ ! -z ${VIASH_PAR_FASTA_OUTPUT+x} ]; then echo "${VIASH_PAR_FASTA_OUTPUT}" | sed "s#'#'\\"'\\"'#g;s#.*#par_fasta_output='&'#" ; else echo "# par_fasta_output="; fi )
