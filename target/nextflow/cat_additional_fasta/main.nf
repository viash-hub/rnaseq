// cat_additional_fasta main_build
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/src/cat_additional_fasta/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/target/nextflow/cat_additional_fasta",
...
par = {
  'fasta': $( if [ ! -z ${VIASH_PAR_FASTA+x} ]; then echo "r'${VIASH_PAR_FASTA//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'gtf': $( if [ ! -z ${VIASH_PAR_GTF+x} ]; then echo "r'${VIASH_PAR_GTF//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'additional_fasta': $( if [ ! -z ${VIASH_PAR_ADDITIONAL_FASTA+x} ]; then echo "r'${VIASH_PAR_ADDITIONAL_FASTA//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'biotype': $( if [ ! -z ${VIASH_PAR_BIOTYPE+x} ]; then echo "r'${VIASH_PAR_BIOTYPE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'versions': $( if [ ! -z ${VIASH_PAR_VERSIONS+x} ]; then echo "r'${VIASH_PAR_VERSIONS//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'fasta_output': $( if [ ! -z ${VIASH_PAR_FASTA_OUTPUT+x} ]; then echo "r'${VIASH_PAR_FASTA_OUTPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'gtf_output': $( if [ ! -z ${VIASH_PAR_GTF_OUTPUT+x} ]; then echo "r'${VIASH_PAR_GTF_OUTPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'updated_versions': $( if [ ! -z ${VIASH_PAR_UPDATED_VERSIONS+x} ]; then echo "r'${VIASH_PAR_UPDATED_VERSIONS//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "data-intuitive/cat_additional_fasta",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
