...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "file",
          "name" : "--output",
          "description" : "Directory containing contents of uncompressed file.",
          "must_exist" : true,
          "create_parent" : true,
          "required" : false,
          "direction" : "output",
  ...
  "test_resources" : [
    ...
    {
      "type" : "file",
      "path" : "testData/minimal_test/reference/hisat2.tar.gz"
    }
  ],
  "info" : {
    "migration_info" : {
  ...
  "build_info" : {
    "config" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/src/untar/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/target/nextflow/untar",
