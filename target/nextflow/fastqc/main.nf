...
meta = [
  ...
  "functionality" : {
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/nirmayi/data_intuitive/rnaseq.vsh/src/fastqc/"
      }
    ],
    ...
    "test_resources" : [
      ...
      {
        "type" : "file",
        "path" : "testData/minimal_test/SRR6357070_1.fastq.gz",
        "parent" : "file:///home/nirmayi/data_intuitive/rnaseq.vsh/"
      },
      {
        "type" : "file",
        "path" : "testData/minimal_test/SRR6357070_2.fastq.gz",
        "parent" : "file:///home/nirmayi/data_intuitive/rnaseq.vsh/"
      }
    ],
    "info" : {
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "output" : "/home/nirmayi/data_intuitive/rnaseq.vsh/target/nextflow/fastqc",
...
$( if [ ! -z ${VIASH_PAR_FASTQC_HTML_1+x} ]; then echo "${VIASH_PAR_FASTQC_HTML_1}" | sed "s#'#'\\"'\\"'#g;s#.*#par_fastqc_html_1='&'#" ; else echo "# par_fastqc_html_1="; fi )
$( if [ ! -z ${VIASH_PAR_FASTQC_HTML_2+x} ]; then echo "${VIASH_PAR_FASTQC_HTML_2}" | sed "s#'#'\\"'\\"'#g;s#.*#par_fastqc_html_2='&'#" ; else echo "# par_fastqc_html_2="; fi )
$( if [ ! -z ${VIASH_PAR_FASTQC_ZIP_1+x} ]; then echo "${VIASH_PAR_FASTQC_ZIP_1}" | sed "s#'#'\\"'\\"'#g;s#.*#par_fastqc_zip_1='&'#" ; else echo "# par_fastqc_zip_1="; fi )
$( if [ ! -z ${VIASH_PAR_FASTQC_ZIP_2+x} ]; then echo "${VIASH_PAR_FASTQC_ZIP_2}" | sed "s#'#'\\"'\\"'#g;s#.*#par_fastqc_zip_2='&'#" ; else echo "# par_fastqc_zip_2="; fi )
