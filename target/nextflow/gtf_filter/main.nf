...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/src/gtf_filter/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/target/nextflow/gtf_filter",
...
par = {
  ...
  'skip_transcript_id_check': $( if [ ! -z ${VIASH_PAR_SKIP_TRANSCRIPT_ID_CHECK+x} ]; then echo "r'${VIASH_PAR_SKIP_TRANSCRIPT_ID_CHECK//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'versions': $( if [ ! -z ${VIASH_PAR_VERSIONS+x} ]; then echo "r'${VIASH_PAR_VERSIONS//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'filtered_gtf': $( if [ ! -z ${VIASH_PAR_FILTERED_GTF+x} ]; then echo "r'${VIASH_PAR_FILTERED_GTF//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "data-intuitive/gtf_filter",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
