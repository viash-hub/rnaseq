...
meta = [
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/nirmayi/data_intuitive/rnaseq.vsh/src/prepare_multiqc_input/"
      }
    ],
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "output" : "/home/nirmayi/data_intuitive/rnaseq.vsh/target/nextflow/prepare_multiqc_input",
...
$( if [ ! -z ${VIASH_PAR_DUPRADAR_MULTIQC+x} ]; then echo "${VIASH_PAR_DUPRADAR_MULTIQC}" | sed "s#'#'\\"'\\"'#g;s#.*#par_dupradar_multiqc='&'#" ; else echo "# par_dupradar_multiqc="; fi )
