...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/src/gtf2bed/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/target/nextflow/gtf2bed",
...
$( if [ ! -z ${VIASH_PAR_BED_OUTPUT+x} ]; then echo "${VIASH_PAR_BED_OUTPUT}" | sed "s#'#'\\"'\\"'#g;s#.*#par_bed_output='&'#" ; else echo "# par_bed_output="; fi )
