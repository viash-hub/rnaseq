...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/src/sortmerna/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/target/nextflow/sortmerna",
...
$( if [ ! -z ${VIASH_PAR_SORTMERNA_LOG+x} ]; then echo "${VIASH_PAR_SORTMERNA_LOG}" | sed "s#'#'\\"'\\"'#g;s#.*#par_sortmerna_log='&'#" ; else echo "# par_sortmerna_log="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "data-intuitive/sortmerna",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
