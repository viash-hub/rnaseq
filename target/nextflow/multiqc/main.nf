...
meta = [
  ...
  "functionality" : {
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/nirmayi/data_intuitive/rnaseq.vsh/src/multiqc/"
      }
    ],
    ...
    "test_resources" : [
      ...
      {
        "type" : "file",
        "path" : "testData/multiqc_test_data",
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "output" : "/home/nirmayi/data_intuitive/rnaseq.vsh/target/nextflow/multiqc",
...
$( if [ ! -z ${VIASH_PAR_MULTIQC_LOGO+x} ]; then echo "${VIASH_PAR_MULTIQC_LOGO}" | sed "s#'#'\\"'\\"'#g;s#.*#par_multiqc_logo='&'#" ; else echo "# par_multiqc_logo="; fi )
