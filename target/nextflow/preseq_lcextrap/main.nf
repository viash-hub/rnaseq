...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/src/preseq_lcextrap/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/target/nextflow/preseq_lcextrap",
...
$( if [ ! -z ${VIASH_PAR_EXTRA_PRESEQ_ARGS+x} ]; then echo "${VIASH_PAR_EXTRA_PRESEQ_ARGS}" | sed "s#'#'\\"'\\"'#g;s#.*#par_extra_preseq_args='&'#" ; else echo "# par_extra_preseq_args="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "data-intuitive/preseq_lcextrap",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
