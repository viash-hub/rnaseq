...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/src/ucsc/bedgraphtobigwig/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/target/nextflow/ucsc/bedgraphtobigwig",
...
$( if [ ! -z ${VIASH_PAR_BEDGRAPH+x} ]; then echo "${VIASH_PAR_BEDGRAPH}" | sed "s#'#'\\"'\\"'#g;s#.*#par_bedgraph='&'#" ; else echo "# par_bedgraph="; fi )
...
$( if [ ! -z ${VIASH_PAR_BIGWIG+x} ]; then echo "${VIASH_PAR_BIGWIG}" | sed "s#'#'\\"'\\"'#g;s#.*#par_bigwig='&'#" ; else echo "# par_bigwig="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "data-intuitive/ucsc/bedgraphtobigwig",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
