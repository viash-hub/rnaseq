...
meta = [
  ...
  "test_resources" : [
    ...
    {
      "type" : "file",
      "path" : "testData/unit_test_resources/test.bedgraph"
    },
    {
      "type" : "file",
      "path" : "testData/unit_test_resources/genome.sizes"
    }
  ],
  "info" : {
    "migration_info" : {
  ...
  "build_info" : {
    "config" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/src/ucsc/bedclip/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/target/nextflow/ucsc/bedclip",
...
$( if [ ! -z ${VIASH_PAR_INPUT_BEDGRAPH+x} ]; then echo "${VIASH_PAR_INPUT_BEDGRAPH}" | sed "s#'#'\\"'\\"'#g;s#.*#par_input_bedgraph='&'#" ; else echo "# par_input_bedgraph="; fi )
$( if [ ! -z ${VIASH_PAR_SIZES+x} ]; then echo "${VIASH_PAR_SIZES}" | sed "s#'#'\\"'\\"'#g;s#.*#par_sizes='&'#" ; else echo "# par_sizes="; fi )
$( if [ ! -z ${VIASH_PAR_VERSIONS+x} ]; then echo "${VIASH_PAR_VERSIONS}" | sed "s#'#'\\"'\\"'#g;s#.*#par_versions='&'#" ; else echo "# par_versions="; fi )
$( if [ ! -z ${VIASH_PAR_OUTPUT_BEDGRAPH+x} ]; then echo "${VIASH_PAR_OUTPUT_BEDGRAPH}" | sed "s#'#'\\"'\\"'#g;s#.*#par_output_bedgraph='&'#" ; else echo "# par_output_bedgraph="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "data-intuitive/ucsc/bedclip",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
