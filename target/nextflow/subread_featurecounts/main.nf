// subread_featurecounts main_build
// 
...
meta = [
  ...
  "info" : {
    "migration_info" : {
      ...
      "paths" : [
        ...
        "modules/nf-core/subread/featurecounts/meta.yml"
      ],
  ...
  "build_info" : {
    "config" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/src/subread_featurecounts/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/target/nextflow/subread_featurecounts",
...
$( if [ ! -z ${VIASH_PAR_EXTRA_FEATURECOUNTS_ARGS+x} ]; then echo "${VIASH_PAR_EXTRA_FEATURECOUNTS_ARGS}" | sed "s#'#'\\"'\\"'#g;s#.*#par_extra_featurecounts_args='&'#" ; else echo "# par_extra_featurecounts_args="; fi )
$( if [ ! -z ${VIASH_PAR_FEATURECOUNTS_GROUP_TYPE+x} ]; then echo "${VIASH_PAR_FEATURECOUNTS_GROUP_TYPE}" | sed "s#'#'\\"'\\"'#g;s#.*#par_featurecounts_group_type='&'#" ; else echo "# par_featurecounts_group_type="; fi )
$( if [ ! -z ${VIASH_PAR_FEATURECOUNTS_FEATURE_TYPE+x} ]; then echo "${VIASH_PAR_FEATURECOUNTS_FEATURE_TYPE}" | sed "s#'#'\\"'\\"'#g;s#.*#par_featurecounts_feature_type='&'#" ; else echo "# par_featurecounts_feature_type="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "data-intuitive/subread_featurecounts",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
