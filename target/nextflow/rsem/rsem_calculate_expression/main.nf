// rsem_calculate_expression main_build
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/src/rsem/rsem_calculate_expression/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/target/nextflow/rsem/rsem_calculate_expression",
...
$( if [ ! -z ${VIASH_PAR_COUNTS_TRANSCTIPS+x} ]; then echo "${VIASH_PAR_COUNTS_TRANSCTIPS}" | sed "s#'#'\\"'\\"'#g;s#.*#par_counts_transctips='&'#" ; else echo "# par_counts_transctips="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "data-intuitive/rsem/rsem_calculate_expression",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
