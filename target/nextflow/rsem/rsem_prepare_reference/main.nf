// rsem_prepare_reference main_build
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/src/rsem/rsem_prepare_reference/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/target/nextflow/rsem/rsem_prepare_reference",
...
$( if [ ! -z ${VIASH_PAR_RSEM+x} ]; then echo "${VIASH_PAR_RSEM}" | sed "s#'#'\\"'\\"'#g;s#.*#par_rsem='&'#" ; else echo "# par_rsem="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "data-intuitive/rsem/rsem_prepare_reference",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
