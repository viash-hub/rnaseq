...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/src/umitools/umitools_dedup/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/target/nextflow/umitools/umitools_dedup",
...
$( if [ ! -z ${VIASH_PAR_GET_OUTPUT_STATS+x} ]; then echo "${VIASH_PAR_GET_OUTPUT_STATS}" | sed "s#'#'\\"'\\"'#g;s#.*#par_get_output_stats='&'#" ; else echo "# par_get_output_stats="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "data-intuitive/umitools/umitools_dedup",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
