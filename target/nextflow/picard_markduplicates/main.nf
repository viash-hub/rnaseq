// picard_markduplicates main_build
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/src/picard_markduplicates/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/rnaseq.vsh/rnaseq.vsh/target/nextflow/picard_markduplicates",
...
$( if [ ! -z ${VIASH_PAR_EXTRA_PICARD_ARGS+x} ]; then echo "${VIASH_PAR_EXTRA_PICARD_ARGS}" | sed "s#'#'\\"'\\"'#g;s#.*#par_extra_picard_args='&'#" ; else echo "# par_extra_picard_args="; fi )
$( if [ ! -z ${VIASH_PAR_VERSIONS+x} ]; then echo "${VIASH_PAR_VERSIONS}" | sed "s#'#'\\"'\\"'#g;s#.*#par_versions='&'#" ; else echo "# par_versions="; fi )
$( if [ ! -z ${VIASH_PAR_OUTPUT_BAM+x} ]; then echo "${VIASH_PAR_OUTPUT_BAM}" | sed "s#'#'\\"'\\"'#g;s#.*#par_output_bam='&'#" ; else echo "# par_output_bam="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "data-intuitive/picard_markduplicates",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
