...
echo $par_fail_trimming_multiqc > $par_output/fail_trimming_multiqc.tsv
echo $par_fail_mapping_multiqc > $par_output/fail_mapping_multiqc.tsv
echo $par_fail_strand_multiqc > $par_output/fail_strand_multiqc.tsv
